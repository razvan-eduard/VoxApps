package com.voxapps.commander.testutil
...
object TestDataFactory {
    ...
    fun createQueryOnlyRule(
        ...
        targetPackage: String = "com.voxapps.commander",
    ...
    ) = com.voxapps.commander.data.remote.RemoteModelItem(
        id = id,
        label = label,
        path = path,
        size_mb = sizeMb,
    ...
    ) = com.voxapps.commander.data.remote.VirtualModelItem(
        id = id,
        label = label,
    ...
    fun createAppSettings(
        voiceProcessor: String = com.voxapps.commander.utils.Strings.Processors.GOOGLE,
        voiceLanguage: String = "en",
        aiProcessor: String = com.voxapps.commander.utils.Strings.AiProcessors.OPENAI,
    ...
    ) = com.voxapps.commander.data.preferences.AppSettings(
