 ...
 *
 * Whisper is not here and never was: it is the one genuinely optional payload (~107MB, only if you
 * pick Whisper STT, with the Vulkan backend linked in and probed at first run), excluded by AGP in
 * both modes and fetched on demand.
 *
