...
object IntentTaxonomy {
    ...
    object Actions {
        ...
        const val NFC_TOGGLE = "nfc_toggle"
        const val AUTO_ROTATE_ON = "auto_rotate_on"
        const val AUTO_ROTATE_OFF = "auto_rotate_off"
        const val AUTO_ROTATE_TOGGLE = "auto_rotate_toggle"
        const val SILENT_MODE_ON = "silent_mode_on"
        const val SILENT_MODE_OFF = "silent_mode_off"
        const val SILENT_MODE_TOGGLE = "silent_mode_toggle"
