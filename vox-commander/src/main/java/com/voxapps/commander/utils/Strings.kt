...
object Strings {
    object Tags {
        ...
        const val VULKAN_PROBE = "GpuProbe"
        ...
        const val LITERT_LLM_INTERPRETER = "LiteRtLlmInterpreter"
    ...
    object Actions {
        const val START_WAKE_WORD = "com.voxapps.commander.action.START_WAKE_WORD"
        const val STOP_WAKE_WORD = "com.voxapps.commander.action.STOP_WAKE_WORD"
        const val PAUSE_WAKE_WORD = "com.voxapps.commander.action.PAUSE_WAKE_WORD"
        const val RESUME_WAKE_WORD = "com.voxapps.commander.action.RESUME_WAKE_WORD"
        const val EXIT_SERVICE = "com.voxapps.commander.action.EXIT_SERVICE"
    }
