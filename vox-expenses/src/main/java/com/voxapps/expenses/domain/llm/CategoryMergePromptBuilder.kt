 ...
 * Mirrors vox-notes' CategoryMergePromptBuilder exactly.
 */
object CategoryMergePromptBuilder {
    fun build(categoryNames: List<String>, languageCode: String): String = """
        ...
        duplicate, e.g. if the list contains "manacare" and "Mancare", return
        {"manacare": "Mancare"}. Do NOT group duplicates into arrays. The canonical name on the
