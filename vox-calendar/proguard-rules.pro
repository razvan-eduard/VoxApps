...
# biweekly (ICS import/export) isn't audited for R8 — it's a third-party library not maintained
# with Android/R8 in mind, so keep it wholesale rather than risk reflection-based property parsing
# silently breaking.
-keep class biweekly.** { *; }
-dontwarn biweekly.**
