...
/**
 * The visual barrier shown while [com.voxapps.calendarapp.state.CalendarUiState.Locked]. Auto-triggers
 * the biometric prompt once on entry; the button lets the user retry after a cancel.
 */
@Composable
