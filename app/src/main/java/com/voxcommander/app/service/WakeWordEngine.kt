...
class WakeWordEngine(
    ...
    private val vadFilter = com.voxcommander.app.utils.BandpassFilter(sampleRate.toFloat(), 300f, 3400f)
    ...
    private fun calculateFilteredRms(filtered: FloatArray, length: Int): Float =
        com.voxcommander.app.utils.AudioConvert.calculateFilteredRms(filtered, length)
}