...
class VoiceTriggerReceiverTest {
    ...
    fun `ACTION_TRIGGER_VOICE constant is correct`() {
        assertEquals("com.voxcommander.app.TRIGGER_VOICE", VoiceTriggerReceiver.ACTION_TRIGGER_VOICE)
    }
    ...
    fun `ACTION_TRIGGER_VOICE follows package naming convention`() {
        assertTrue(VoiceTriggerReceiver.ACTION_TRIGGER_VOICE.startsWith("com.voxcommander.app."))
    }
    ...
    fun `WakeWordService ACTION_EXTERNAL_TRIGGER is correct`() {
        assertEquals("com.voxcommander.app.EXTERNAL_TRIGGER", WakeWordService.ACTION_EXTERNAL_TRIGGER)
    }
