 ...
 * whenever it lands, so this worker's job is done as soon as the request is durably enqueued — no
 * need to pre-check whether Commander is installed, [CategoryMergeRequestSender] routes through
